...
var file_shortlink_proto_rawDesc = []byte{
	...
	0x6e, 0x55, 0x72, 0x6c, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x69, 0x6e, 0x2e, 0x4f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x55, 0x72, 0x6c, 0x1a, 0x0e, 0x2e, 0x6d,
	0x61, 0x69, 0x6e, 0x2e, 0x53, 0x68, 0x6f, 0x72, 0x74, 0x55, 0x72, 0x6c, 0x22, 0x00, 0x12, 0x28,
	0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x0e, 0x2e, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x53, 0x68, 0x6f,
	0x72, 0x74, 0x55, 0x72, 0x6c, 0x1a, 0x0f, 0x2e, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x4f, 0x72, 0x69,
	0x67, 0x69, 0x6e, 0x55, 0x72, 0x6c, 0x22, 0x00, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x61, 0x70, 0x69,
...
type ShortlinkClient interface {
	Create(ctx context.Context, in *OriginUrl, opts ...grpc.CallOption) (*ShortUrl, error)
	Get(ctx context.Context, in *ShortUrl, opts ...grpc.CallOption) (*OriginUrl, error)
}
...
func (c *shortlinkClient) Create(ctx context.Context, in *OriginUrl, opts ...grpc.CallOption) (*ShortUrl, error) {
	out := new(ShortUrl)
	err := c.cc.Invoke(ctx, "/main.Shortlink/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shortlinkClient) Get(ctx context.Context, in *ShortUrl, opts ...grpc.CallOption) (*OriginUrl, error) {
	out := new(OriginUrl)
	err := c.cc.Invoke(ctx, "/main.Shortlink/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShortlinkServer interface {
	Create(context.Context, *OriginUrl) (*ShortUrl, error)
	Get(context.Context, *ShortUrl) (*OriginUrl, error)
}
...
func (*UnimplementedShortlinkServer) Create(context.Context, *OriginUrl) (*ShortUrl, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (*UnimplementedShortlinkServer) Get(context.Context, *ShortUrl) (*OriginUrl, error) {
...
func _Shortlink_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.Shortlink/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShortlinkServer).Create(ctx, req.(*OriginUrl))
	}
...
func _Shortlink_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.Shortlink/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShortlinkServer).Get(ctx, req.(*ShortUrl))
	}
	return interceptor(ctx, in, info, handler)
}

var _Shortlink_serviceDesc = grpc.ServiceDesc{
	ServiceName: "main.Shortlink",
